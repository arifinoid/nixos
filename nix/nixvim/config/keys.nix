{
  keymaps = [
    ...
    }
    {
      key = "<leader>m";
      mode = "n";
      action = ":lua require('llm').create_llm_md()<CR>";
      options = {
        silent = true;
        noremap = true;
        desc = "Create llm.md";
    ...
    }
    {
      key = "<leader>,";
      mode = [ "n" "v" ];
      action = ":lua require('llm').prompt({ replace = false, service = 'groq' })<CR>";
      options = {
        silent = true;
        noremap = true;
    ...
    }
    {
      key = "<leader>.";
      mode = "v";
      action = ":lua require('llm').prompt({ replace = true, service = 'groq' })<CR>";
      options = {
        silent = true;
        noremap = true;
    ...
    }
    {
      key = "<leader>g,";
      mode = [ "n" "v" ];
      action = ":lua require('llm').prompt({ replace = false, service = 'openai' })<CR>";
      options = {
        silent = true;
        noremap = true;
    ...
    }
    {
      key = "<leader>g.";
      mode = "v";
      action = ":lua require('llm').prompt({ replace = true, service = 'openai' })<CR>";
      options = {
        silent = true;
        noremap = true;
    ...
    }
    {
      key = "g,";
      mode = "n";
      action = ":lua require('llm').prompt_operatorfunc({ replace = false, service = 'groq' })<CR>";
      options = {
        silent = true;
        noremap = true;
        desc = "Prompt with groq";
    ...
    }
    {
      key = "g.";
      mode = "n";
      action = ":lua require('llm').prompt_operatorfunc({ replace = true, service = 'groq' })<CR>";
      options = {
        silent = true;
        noremap = true;
        desc = "Prompt while replacing with groq";
